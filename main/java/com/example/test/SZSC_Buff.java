...
public class SZSC_Buff {
    ...
    public void set_source(int Source_type,int Source_player_ID,int which_one) {
        ...
        this.Source_effect_column=which_one;
    }
    ...
    public void set_use_limit(boolean whether_token,boolean chain_level_limit,String use_limit_type,int use_times_limit,int consume_value_per_time,int first_remain_value)//buff添加使用次数限制
    {
        ...
        this.consume_value_per_time=consume_value_per_time;
        this.use_times_remain=first_remain_value;
    }
