...
public class SYSTEM_EXCEL implements AutoCloseable{
    ...
    String file_path;
    public SYSTEM_EXCEL(String file_path,int sheet_No) {
        ...
        try {
            ...
            show("创建excel连接出错 "+file_path+"   "+sheet_No+"\n"+e.getMessage());
        }
    }
                    ...
                    case FORMULA:
                    {
                        ...
                        switch (evalResult.getCellType()) {
                            case NUMERIC:
                                ...
                                break;
                            case STRING:
                                if(evalResult.getStringValue().isEmpty())
                                    break;
                    ...
                    case FORMULA:
                    {
                        ...
                        switch (evalResult.getCellType()) {
                            case NUMERIC:
                                ...
                                break;
                            case STRING:
                                if(evalResult.getStringValue().isBlank())
                                    break;
